...
class OTAViewController: NSViewController {
	// MARK:- IBOutlets
	...
	@IBAction func helpPressed(sender: NSButton) {
		NSWorkspace.sharedWorkspace().openURL(NSURL(string: "https://github.com/roonieone/Extractr/blob/master/README.md")!)
	}
